  ...
  getNextPossibleStatesAndCost(size_t curCost) const {
    ...
    for (auto i = 0; i < amphipods.size(); ++i) {
      ...
      if (amphi.moved) {
        ...
        //           << roomCoordinate << "\n";
        if (int steps = stepsTo(g, amphi.x, amphi.y, roomCoordinate, 4);
            steps >= 0) {
        ...
        } else if (int steps = stepsTo(g, amphi.x, amphi.y, roomCoordinate, 3);
                   steps >= 0) {
          ...
          s.amphipods[i].y = 3;
          ret.emplace_back(s, curCost + steps * amphi.moveCost);
        } else if (int steps = stepsTo(g, amphi.x, amphi.y, roomCoordinate, 2);
                   steps >= 0) {
          // std::cout << "Got something2!\n";
          State s = *this;
          s.amphipods[i].x = roomCoordinate;
...
int main(int argc, char **argv) {
  ...
  start.amphipods[8 + 0].desiredRoom = 0;
  start.amphipods[8 + 0].x = 7;
  start.amphipods[8 + 0].y = 3;
  start.amphipods[8 + 1].desiredRoom = 0;
  start.amphipods[8 + 1].x = 9;
  start.amphipods[8 + 1].y = 2;
  start.amphipods[8 + 2].desiredRoom = 1;
  start.amphipods[8 + 2].x = 7;
  start.amphipods[8 + 2].y = 2;
  start.amphipods[8 + 2].moveCost = 10;
  start.amphipods[8 + 3].desiredRoom = 1;
  start.amphipods[8 + 3].x = 5;
  start.amphipods[8 + 3].y = 3;
  start.amphipods[8 + 3].moveCost = 10;
  start.amphipods[8 + 4].desiredRoom = 2;
  start.amphipods[8 + 4].x = 9;
  start.amphipods[8 + 4].y = 3;
  start.amphipods[8 + 4].moveCost = 100;
  start.amphipods[8 + 5].desiredRoom = 2;
  start.amphipods[8 + 5].x = 5;
  start.amphipods[8 + 5].y = 2;
  start.amphipods[8 + 5].moveCost = 100;
  start.amphipods[8 + 6].desiredRoom = 3;
  start.amphipods[8 + 6].x = 3;
  start.amphipods[8 + 6].y = 2;
  start.amphipods[8 + 6].moveCost = 1000;
  start.amphipods[8 + 7].desiredRoom = 3;
  start.amphipods[8 + 7].x = 3;
  start.amphipods[8 + 7].y = 3;
  start.amphipods[8 + 7].moveCost = 1000;
