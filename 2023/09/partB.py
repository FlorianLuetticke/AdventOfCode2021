...
class Hand:
    def __init__(self, cards, bid):
        ...
        self.unique_count = [value for key,
                             value in card_map.items() if key != "J"]
        self.unique_count.append(0)  # all jokers
        self.unique_count.sort()
        self.unique_count[-1] += card_map["J"]
